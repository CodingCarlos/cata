<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="beneficios.aspx.vb" Inherits="_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="lipsum">
        ...
        <p>
            <asp:Image ID="Image10" runat="server" Height="263px" ImageUrl="~/img/birra.JPG" CssClass="inset" style="float:left;" Width="331px" />
        ...
        <p>
            <asp:Image ID="Image11" runat="server" Height="263px" ImageUrl="~/img/homerPeterBender.jpg" CssClass="inset" style="float:right;" Width="331px" />
